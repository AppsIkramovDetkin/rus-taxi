...
-   Colors should be used through the constants declared in UIColor+Eduson.swift, if it not exist, you need to create it
...
-   Do not discuss in PM, only in Slack Chat, named  _eduson_
