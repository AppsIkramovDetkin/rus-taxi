...
var menuItems: [String] {
	return [Localize("pay"), Localize("profile"), Localize("trips"), Localize("authBig"), Localize("settingsBig"), Localize("conFeedBack"), Localize("aboutProgramm"), Localize("aboutTaxiBig")]
}
