...
enum TaxiColor {
	...
	static let purple: UIColor = UIColor(netHex: 0xEB3C83)
	static let taxiOrange: UIColor = UIColor(netHex: 0xFFBB33)
...
let negativeComment: [String] = [Localize("driverLate"), Localize("roughDriver"), Localize("carDirty"), Localize("driverBlackList")]
...
let menuItems: [String] = [Localize("pay"), Localize("profile"), Localize("trips"), Localize("authBig"), Localize("settingsBig"), Localize("conFeedBack"), Localize("aboutProgramm"), Localize("aboutTaxiBig")]
